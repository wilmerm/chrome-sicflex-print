...
function printPagina(intentos=0) {
    ...
    try {
        var oldTitle = document.getElementById("module_description").innerText;
        var oldColor = document.getElementById("module_description").style.backgroundColor;
        document.getElementById("module_description").innerText = "Imprimiendo por la extención. Espere...";
        document.getElementById("module_description").style.backgroundColor = "yellow";
        location.href = "#module_description";
    } catch (error) {}
    ...
    if (!get(numero)) {
        alert("No hay ninguna factura para imprimir.");
        try {
            document.getElementById("module_description").innerText = oldTitle;
            document.getElementById("module_description").style.backgroundColor = oldColor;
        } catch (error) {}
        return;
    }
