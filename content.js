...
const base_items_id = 'ox_jSicflexWebApp_InventoryInvoice__xava_collectionTab_imatrs_'; // agregamos el indice de la columna al final col0, col1
const base_items_devolucion_id = 'ox_jSicflexWebApp_InventoryInvoiceReturn__xava_collectionTab_imatrs_'; // agregamos el indice de la columna al final col0, col1
